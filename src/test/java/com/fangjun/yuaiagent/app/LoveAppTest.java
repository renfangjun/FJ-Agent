...
class LoveAppTest {
    ...
    void doChatWithReport() {
        String chatId = UUID.randomUUID().toString();
        //第一轮
        String message = "你好,我是方俊, 我想让另一半（编程导航）更爱我,但我不知道该怎么做";
    ...
    @Test
    void doChatWithCloudRagAndReport() {
        String chatId = UUID.randomUUID().toString();
        String message = "我已经结婚了，但是婚后关系不太亲密，怎么办？";
        String answer =  loveApp.doChatWithCloudRagAndReport(message, chatId);
        Assertions.assertNotNull(answer);
    }
    ...
    void doChatWithPgVector() {
        String chatId = UUID.randomUUID().toString();
        String message = "编程该怎么学？";
        String answer =  loveApp.doChatWithPgVector(message, chatId);
        Assertions.assertNotNull(answer);
    }
